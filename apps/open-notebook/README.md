...
> **Note: orchestratorai-v2 Integration**
>
> This is a modified version of [Open Notebook](https://github.com/lfnovo/open-notebook) integrated into the orchestratorai-v2 monorepo.
>
> **Modifications:**
> - Supabase JWT authentication (replaces password auth)
> - Port changes: Frontend (6201), API (6202), SurrealDB (6203)
>
