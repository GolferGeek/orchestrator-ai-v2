...
--
-- Name: idx_orchestration_runs_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_orchestration_runs_user_id ON public.orchestration_runs USING btree (user_id);
...
--
-- Name: orchestration_runs orchestration_runs_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orchestration_runs
    ADD CONSTRAINT orchestration_runs_user_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
