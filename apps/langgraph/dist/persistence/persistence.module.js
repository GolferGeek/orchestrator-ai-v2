...
const postgres_checkpointer_service_1 = require("./postgres-checkpointer.service");
...
exports.PersistenceModule = PersistenceModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [postgres_checkpointer_service_1.PostgresCheckpointerService],
        exports: [postgres_checkpointer_service_1.PostgresCheckpointerService],
    })
], PersistenceModule);
