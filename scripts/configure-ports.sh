...
# Set worktree-specific flags
sed -i '' "s/^DISABLE_SCHEDULED_CRAWLING=.*/DISABLE_SCHEDULED_CRAWLING=true/" "$ENV_FILE"
sed -i '' "s/^DISABLE_PREDICTION_RUNNERS=.*/DISABLE_PREDICTION_RUNNERS=true/" "$ENV_FILE"
...
echo "  DISABLE_SCHEDULED_CRAWLING=true"
echo "  DISABLE_PREDICTION_RUNNERS=true"
