...
# Full Ollama setup - 3 models for 96GB+ systems (your laptop)
echo "🚀 Starting Ollama Full (3 models)"
...
echo "✅ Full Ollama setup started!"
echo "Models: llama3.2:latest, qwen3:8b, gpt-oss:20b"
echo "Estimated RAM usage: ~30GB"
