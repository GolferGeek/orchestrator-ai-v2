...
This template provides a structure for creating architecture agents that are domain specialists for building and modifying code.
...
```
Task: "Build a new [domain] feature"

Workflow:
1. Load execution-context-skill, transport-types-skill, [domain]-architecture-skill
2. Classify: This is a [file type] ([domain]-architecture-skill)
3. Create [file type] following [domain] patterns
4. Ensure ExecutionContext is received correctly (execution-context-skill)
...
```
Task: "Update the [component] to add new functionality"
...
### Example: web-architecture-agent

**Key Sections:**
- Purpose: Vue.js web application specialist
...
- Domain Patterns: Three-layer architecture, Vue 3 Composition API, ExecutionContext from store
- Examples: Building components, modifying stores, creating services

### Example: api-architecture-agent

**Key Sections:**
- Purpose: NestJS API specialist
- Mandatory Skills: execution-context-skill, transport-types-skill, api-architecture-skill
- Workflow: Before/During/After work patterns
- Domain Patterns: NestJS modules, dependency injection, LLM service, Observability
- Examples: Building endpoints, creating services, implementing runners

### Example: langgraph-architecture-agent

**Key Sections:**
- Purpose: LangGraph workflow specialist
- Mandatory Skills: execution-context-skill, transport-types-skill, langgraph-architecture-skill
- Workflow: Before/During/After work patterns
- Domain Patterns: StateGraph, nodes, edges, HITL, database state, LLM service, Observability
- Examples: Building workflows, creating nodes, implementing HITL
