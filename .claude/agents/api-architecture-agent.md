...
mandatory-skills: ["self-reporting-skill", "execution-context-skill", "transport-types-skill", "api-architecture-skill"]
optional-skills: ["api-testing-skill", "pivot-learning-skill"]
...
VALUES ('agent', 'api-architecture-agent', 'invoked',
...
VALUES ('agent', 'api-architecture-agent', 'completed', true,
...
INSERT INTO code_ops.pivot_learnings (
  ...
  ARRAY['typescript', 'nestjs']  -- relevant tags
);"
```
...
docker exec supabase_db_api-dev psql -U postgres -d postgres -c "
INSERT INTO code_ops.artifact_events (artifact_type, artifact_name, event_type, success, details)
VALUES ('agent', 'api-architecture-agent', 'completed', false,
